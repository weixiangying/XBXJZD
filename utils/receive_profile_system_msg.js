...
function onProfileModifyNotify(notify) {
    ...
    var typeCh = "[资料修改]";
    var profile, account, nick, sex, allowType, content, image;
    ...
    for (var i in notify.ProfileList) {
        ...
        switch (profile.Tag) {
            ...
            case 'Tag_Profile_IM_Image':
                ...
                break;
            default:
                console.log('未知资料字段：' + JSON.stringify(profile));
                break;
        }
    }
...
function initGetMyProfileSystemMsgs(data) {
    console.log('初始化我的资料系统消息表格==', data);
...
module.exports = {
    onProfileModifyNotify: onProfileModifyNotify,
    initGetMyProfileSystemMsgs: initGetMyProfileSystemMsgs
};