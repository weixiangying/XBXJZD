...
function onReadedSyncGroupNotify(notify) {
    ...
    //更新当前的seq
    var currentUnRead = app.recentSessMap[webim.SESSION_TYPE.GROUP + "_" + notify.GroupId].MsgGroupReadedSeq;
    var unread = currentUnRead - seq;
    unread = unread > 0 ? unread : 0;
    app.recentSessMap[webim.SESSION_TYPE.GROUP + "_" + notify.GroupId].MsgGroupReadedSeq = seq;
...
function initGetMyGroupSystemMsgs(data) {
    console.log('初始化我的群组系统消息表格==', data);
...
module.exports = {
    ...
    onReadedSyncGroupNotify: onReadedSyncGroupNotify,
    onCustomGroupNotify: onCustomGroupNotify,
    onInvitedJoinGroupNotifyRequest: onInvitedJoinGroupNotifyRequest,
    onGroupInfoChangeNotify: onGroupInfoChangeNotify,
    initGetMyGroupSystemMsgs: initGetMyGroupSystemMsgs
};