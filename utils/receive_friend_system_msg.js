...
function initGetMyFriendSystemMsgs(data) {
    console.log('初始化我的好友系统消息表格==', data);
...
module.exports = {
    onFriendAddNotify: onFriendAddNotify,
    onFriendDeleteNotify: onFriendDeleteNotify,
    onPendencyAddNotify: onPendencyAddNotify,
    onPendencyDeleteNotify: onPendencyDeleteNotify,
    onBlackListAddNotify: onBlackListAddNotify,
    onBlackListDeleteNotify: onBlackListDeleteNotify,
    initGetMyFriendSystemMsgs: initGetMyFriendSystemMsgs
}